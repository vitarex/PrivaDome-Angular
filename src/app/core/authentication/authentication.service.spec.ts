...
import { MockLoginService } from '../login/login.service.mock';
...
describe('AuthenticationService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [AuthenticationService, { provide: LoginService, useClass: MockLoginService }]
    });
  });

  beforeEach(inject(
    [AuthenticationService, LoginService],
    (_authenticationService: AuthenticationService, _loginService: MockLoginService) => {
